...
with st.sidebar:
    ...
    # (Opcional) lo dejamos visible, pero el título FINAL para export y nombre de archivo
    # se construye SIEMPRE desde `delegacion` para que no se quede con un valor viejo.
    _ = st.text_input(
...
if "seed_cargado" not in st.session_state:
    ...
    seed = [
        ...
        # ---------------- I. DATOS DEMOGRÁFICOS (mantiene igual + Q6 tipo local) ----------------
...
def construir_xlsform(preguntas, form_title: str, idioma: str, version: str,
    ...
    # P3 Demográficos (con texto de contexto comercio)
    add_page(
        "p3_demograficos",
